...
def camera_recog():
    ...
    while True:
        ...
        rects, landmarks = face_detect.detect_face(frame,5)#min face size is set to 80x80
        aligns = []
        positions = []
        ...
        # This run the detection of peoples and their situations.
        YOLO_OBJECT.detection_people(_, frame)

        cv2.putText(frame, "FPS : " + str((1.0 / (time.time() - start_time_fps))),
